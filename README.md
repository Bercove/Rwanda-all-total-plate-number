# Rwanda-all-total-plate-number
Rwanda All total cars plate number is a simple project which prints out all total plate number that might be available in Rwanda
